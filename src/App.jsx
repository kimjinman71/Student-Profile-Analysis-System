...
3. 역량별 가치 점수화: 학업역량, 진로역량, 공동체역량 각각에 어울리는 정량 점수(60~100점 사이)를 부여하고, 평가 등급은 오직 다음의 8단계 기본단계 등급(A+, A, A-, B+, B, B-, C+, C) 중 하나를 엄격히 부여하십시오.
4. 봉사활동은 대입 미반영 항목이므로 역량 분석에서 완전히 제외하십시오.
5. 종합 사정관 의견(admissions_verdict): 학생부 전체 성과, 전공 진실성, 향후 대학 입시에서의 경쟁력과 주의점에 대해 엄격하게 3~4문장 분량의 핵심 심층 총평을 작성하십시오.
6. 과목순서: 국어교과군, 수학교과군, 영어교과군, 과학교과군, 사회교과군, 기타교과군 순서로 엄격하게 배열하십시오.
7. 문장 내 따옴표는 작은 따옴표(')만 사용하십시오.
8. 결과는 지정된 유효한 JSON 형식으로만 응답하십시오.`;
