...
const App = () => {
  ...
  const analyzeStudentRecord = async (isReParseVal = false) => {
    ...
    try {
      let currentExtractedTexts = extractedTexts;
...
2. [노이즈 필터링 (Fluff Filtering)]:
   ...
   - 오직 [동기 -> 구체적 역량 활동 -> 결과 및 변화] 구조를 지닌 실질적이고 인과적인 의미 있는 문맥만을 유효 평가 데이터로 인정하여 점수를 가산하십시오.
3. [등급 및 점수 산정]:
   - A+ 등급: 내신 1.00 ~ 1.20 범위 내이며, 고교 유형이 '전국단위 자사고', '영재/과학고', '외고/국제고' 중 하나일 때에만 부여하십시오. 그 외의 모든 조건(일반고 등)에서는 절대 A+ 등급을 부여할 수 없습니다.
   - A ~ B+ 등급: 내신 1.30 ~ 1.99 사이인 경우, 학생부 내용이 우수하다면 A(또는 A-)에서 B+ 범위에서 등급을 부여하십시오.
   - B 등급: 내신 2.00 ~ 3.00 사이인 경우 대부분 B(또는 B-) 등급으로 평가하되, 구체적인 탐구 내용이 풍부한 경우에만 B+ 등급으로 상향 평가하십시오.
...
Index 0: 주요 교과 성적 전공 기초 학업에 충분히 우수한가
Index 1: 전공 관련 선택 과목 성취도가 고교 표준 성적 대비 우수한가
Index 2: 학년이 올라갈수록 성취 추이가 안정적으로 유지 또는 향상되었는가
Index 3: 과목별 편차(표준편차/등급)가 지나치게 크지 않고 고른가
Index 4: 경쟁자 대비 선도적인 내신 경쟁력 및 성취도를 갖추었는가
Index 5: 토론 및 주도적 참여도가 수업 과정 기록에 적극적으로 나타나는가
Index 6: 지적 한계 극복을 위한 질문과 성찰적 토론이 충분히 나타나는가
Index 7: 교과 심화를 이끌어낸 발표 경험이 생활기록부에 충실히 기록되어 있는가
Index 8: 자기성찰적인 학습 태도와 끈기가 모든 세특에서 일관되게 우수한가
Index 9: 단순 지식 암기를 넘어 심화 개념을 구조화한 학술 탐구가 이루어졌는가
Index 10: 탐구 설계의 주제가 실증적이며 학술적으로 정합하고 구체적인가
Index 11: 탐구 중 수리적/과학적 원리에 입각한 정교한 자료 분석 과정이 있는가
Index 12: 예기치 못한 오차 발생 시 능동적인 한계 규명 및 문제 해결 과정이 나타나는가
Index 13: 탐구 결과를 실생활의 최신 트렌드나 타 교과의 이론적 접점으로 확장하였는가
Index 14: 학년이 올라갈수록 탐구의 깊이와 논문의 활용 수준이 연쇄적으로 심화되었는가
Index 15: 수업 방관을 예방하고 주도적인 학업 태도로 이끈 적극적 발전이 있는가
Index 16: 원점수 및 과목 성취도가 학업 여정에서 선제적으로 향상되었는가
Index 17: 학문적인 호기심이 단절 없이 3년간 지속적·유기적으로 나타나는가
Index 18: 지원 전공의 기초 핵심이 되는 수·과학 과목을 빠짐없이 선택하였는가
Index 19: 난도가 높은 고교 외 전문교과나 심화과목 이수를 위해 적극 노력했는가
Index 20: 선택 과목 간의 학제적 가이드라인이 어긋남 없이 일관성을 띄는가
Index 21: 학생수 미달 등으로 등급 획득이 불리하더라도 도전적인 선택을 하였는가

[진로역량 평정 질문 18가지 (인덱스 순서)]:
Index 0: 전공 목표가 고연차로 진급할수록 좁혀지고 명확히 성문화되는가
Index 1: 특정 이공 분야에 대한 관심도가 진로활동에 일관적으로 나타나는가
Index 2: 진로 관심의 궤적이 단발성에 그치지 않고 심화 확장되는가
Index 3: 교과 세특을 관통하는 전공 지향 연구 및 학술 탐구가 구체적으로 존재하는가
Index 4: 동아리나 교내 활동 중 주도적 전공 연계 프로젝트를 성실히 기획한 경험이 있는가
Index 5: 전공 탐구 성과를 동료와 공유하기 위한 다변화된 발표 경험이 나타나는가
Index 6: 전공 주제 해결을 위해 전공 서적 발췌 분석 및 깊이 있는 조사를 수행했는가
Index 7: 희망 분야의 기반 원리와 기술적 장벽을 충분히 이해하고 전개하는가
Index 8: 전공 분야와 긴밀히 얽힌 현대 사회적 딜레마(예: 윤리 등)를 구조적으로 이해하는가
Index 9: 학계 및 산업계의 최신 바이오/공학 트렌드를 정교히 수렴하고 해석해냈는가
Index 10: 단순 개인적 흥미 수용을 넘어 대학 전공 기초에 준하는 학문적 이해도가 돋보이는가
Index 11: 전공 기초를 튼튼하게 보좌해줄 수 있는 과목(수학II, 전문과학 등)을 성실히 수강했는가
Index 12: 해당 분야 대학 진학 후 이탈 없이 완주할 수 있는 준비된 전공 적합 이수가 있는가
Index 13: 개별 탐구물 중 지원 학과의 기초 개념과 일대일 정합하여 증명해내는 경험이 충분한가
Index 14: 교과 세특의 탐구 논지가 자율/진로활동 기록과 긴밀히 융합하여 흐르는가
Index 15: 상설 동아리의 세부 탐구 성과물이 교과 수업 과제로 영리하게 연계 연쇄되는가
Index 16: 1학년부터 3학년까지 전공을 향한 관심의 깊이가 심화 경로를 따르는가
Index 17: 최종 서류 사정관이 보았을 때 본 학생부의 전체 방향이 지원 전공과 매끄럽게 연결되는가`;

      const systemPromptB = `당신은 대한민국 최고 수준의 대학 입시 심사관이자 학생부 분석 전문가입니다.
제시된 학생부 텍스트를 고도로 정밀 분석하여 [공동체역량(community)]을 평가하고, [종합 사정관 의견(admissions_verdict)]을 생성해 주십시오.
...
2. [노이즈 필터링 (Fluff Filtering)]:
   ...
   - 오직 [동기 -> 구체적 역량 활동 -> 결과 및 변화] 구조를 지닌 문맥만을 유효 평가 데이터로 인정하여 점수를 가산하십시오.
3. [등급 및 점수 산정]:
...
Index 0: 다양한 교과 수행평가 중 모둠형 학술 과제를 성실히 수행한 누적이 기록되었는가
Index 1: 실험 설계나 자료 요약 분담 중 이타적 협력 구조가 관찰 기록되었는가
Index 2: 본인이 기여한 역할의 범위와 학술적 담당 영역이 구체적으로 명시되었는가
Index 3: 서로 대립하는 급우들이 하나의 지적 산출물 완성하도록 유도해 보았는가
Index 4: 학업적 성과를 타인에게 가시화하여 논리적으로 전수하고 설득하는 발표가 돋보이는가
Index 5: 모둠별 학술 토론 중 경청의 자세와 타인의 연구 방안을 정교하게 피드백했는가
Index 6: 의견 대립 시 감정에 치우치지 않고 통계와 합리적 이론에 입각한 조율 사례가 있는가
Index 7: 수업 진행 시 교사의 교안이나 동료의 견해를 수렴하는 개방적 경청 태도가 확실한가
Index 8: 수업 및 실험 기자재 관리, 학습 도우미 등 학급 소임을 충실히 전개했는가
Index 9: 부장 활동이나 모둠 리더로서 프로젝트 전 주기에 걸쳐 연속적으로 참여했는가
Index 10: 지필 평가 준비 중에도 멘토링이나 안전지킴이 등 공공 업무를 끝까지 완주했는가
Index 11: 모둠원의 탈퇴 등 예상치 못한 위기에도 팀 과제를 끝까지 지키고 책임졌는가
Index 12: 임원 선출 등 거창한 직함을 넘어, 모둠 탐구를 이끌어낸 리더십 경험이 상세한가
Index 13: 부진한 공동 결과물 도출을 방지하기 위해 적극적인 개선 해결책을 선제 제시했는가
Index 14: 자신이 리더가 아닐지라도 주도적으로 동료들의 학술적 애로사항을 확인 지원했는가
Index 15: 급우들의 탐구욕을 자극하고 수리/과학 학습 풍토를 조성하는 긍정적 시너지를 발휘했는가
Index 16: 개인주의를 탈피하고 학습 격차가 큰 동료에게 자신만의 공부 가이드를 배려했는가
Index 17: 동아리 활동 및 학급 행정 전반에 이타적인 방향으로 기여해본 직접적인 사례가 있는가
Index 18: 대입 반영 축소와 무관하게 학급 내 청소나 행사 지원 등에 순수한 희생을 보였는가
Index 19: 동료 평가나 사정관 면접 질문 시 성숙한 지적 인격과 인성을 겸비하고 있음이 입증되는가`;

      const systemPromptC = `당신은 대한민국 최고 수준의 대학 입시 심사관이자 학생부 분석 전문가입니다.
제시된 학생부 텍스트를 고도로 정밀 분석하여 [5대 교과군 세특 정성 분석(subject_specific)] 및 관련 루브릭 정보를 생성해 주십시오.
...
2. [5대 교과군 구성 및 정렬 순서]:
   ...
   2) 수학 교과군 분석 (category: "math")
   3) 영어 교과군 분석 (category: "english")
   4) 과학 교과군 분석 (category: "science")
   5) 사회 교과군 분석 (category: "social")
...
Index 0: 수업 내용을 단순 암기를 넘어 깊이 있게 이해하고 완벽히 소화했는가
Index 1: 학문적 호기심을 바탕으로 주도적인 질문을 스스로 생성했는가
Index 2: 가설 수립 및 실험과정 설계 등 능동적인 탐구 활동을 직접 수행했는가
Index 3: 탐구 전반에서 수집된 객관적이고 구체적인 자료를 체계적으로 분석했는가
Index 4: 교과 연계 심화 활동 기록이 희망 진로 및 전공과 부합하게 연결되는가
Index 5: 학년이 올라갈수록 탐구 수준과 연구의 성취도가 점진적으로 성장했는가
...
교과학습발달상황: ${currentExtractedTexts.academic_text}`;
      ...
      if (isReParse && analysisResult) {
        userPromptA = `[누락 데이터 집중 복원 요청]
이전에 생성된 불완전한 결과는 다음과 같습니다:
학업역량: ${JSON.stringify(analysisResult.competencies?.academic || {})}
진로역량: ${JSON.stringify(analysisResult.competencies?.career || {})}
학업 루브릭: ${JSON.stringify(analysisResult.rubrics?.academic || [])}
진로 루브릭: ${JSON.stringify(analysisResult.rubrics?.career || [])}

위의 이전 결과에서 강점(strengths)이나 보완점(weaknesses)이 비어있거나 누락된 항목이 있다면 원본 텍스트를 분석하여 채우십시오.
기존에 채워진 텍스트가 있다면 내용을 변경하지 말고 그대로 복사해서 출력하십시오.
창의적체험활동: ${currentExtractedTexts.extracurricular_text}
교과학습발달상황: ${currentExtractedTexts.academic_text}`;

        userPromptB = `[누락 데이터 집중 복원 요청]
이전에 생성된 불완전한 결과는 다음과 같습니다:
공동체역량: ${JSON.stringify(analysisResult.competencies?.community || {})}
종합 사정의견: "${analysisResult.admissions_verdict || ''}"
공동체 루브릭: ${JSON.stringify(analysisResult.rubrics?.community || [])}

위의 이전 결과에서 강점이나 보완점이 비어있거나 누락된 항목이 있다면 원본 텍스트를 분석하여 채우십시오.
기존에 채워진 텍스트가 있다면 내용을 변경하지 말고 그대로 복사해서 출력하십시오.
창의적체험활동: ${currentExtractedTexts.extracurricular_text}
교과학습발달상황: ${currentExtractedTexts.academic_text}`;

        userPromptC = `[누락 데이터 집중 복원 요청]
이전에 생성된 불완전한 결과는 다음과 같습니다:
교과군 분석: ${JSON.stringify(analysisResult.subject_specific || [])}
교과 루브릭: ${JSON.stringify(analysisResult.rubrics?.subject || [])}
...
교과학습발달상황: ${currentExtractedTexts.academic_text}`;
      ...
      const taskASchema = {
        ...
        properties: {
          ...
          rubrics: {
            ...
            required: ["academic", "career"]
          }
        },
        required: ["academic", "career", "rubrics"]
      };
      ...
      const taskBSchema = {
        ...
        required: ["community", "admissions_verdict", "rubrics"]
      };
      ...
      const taskCSchema = {
        ...
        required: ["subject_specific", "rubrics"]
      };

      const baseApiUrl = `https://generativelanguage.googleapis.com/v1beta/models/${MODEL_NAME}:generateContent?key=${currentApiKey}`;

      const runTask = async (systemInstruction, userPrompt, responseSchema) => {
        const payload = {
        ...
        const resData = await fetchWithRetry(baseApiUrl, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(payload)
        });
        ...
        const parsed = cleanAndParseJson(raw);
        if (!parsed) {
          throw new Error("파싱 응답이 불완전하거나 손상되었습니다.");
        }
        return parsed;
      };
      ...
      const [resA, resB, resC] = await Promise.all([
        runTask(systemPromptA, userPromptA, taskASchema).catch(err => {
          console.error("Task A failed:", err);
          throw new Error("학업 및 진로역량 정성 평가 과정 중 오류가 발생했습니다.");
        }),
        runTask(systemPromptB, userPromptB, taskBSchema).catch(err => {
          console.error("Task B failed:", err);
          throw new Error("공동체역량 및 종합 판독서 작성 중 오류가 발생했습니다.");
        }),
        runTask(systemPromptC, userPromptC, taskCSchema).catch(err => {
          console.error("Task C failed:", err);
          throw new Error("5대 교과군 세특 세부 판독 과정 중 오류가 발생했습니다.");
        })
      ]);
      ...
      if (isReParse) {
        setActiveResultTab('report'); // Re-parsed successfully, route to report tab
      } else {
        setActiveResultTab('admission'); // First analysis success, route to prediction tab
      }
    } catch (err) {
      console.error(err);
      setError(`생활기록부 정밀 분석 중 오류가 발생했습니다. (${err.message}). API 키 유효성 및 네트워크 상태를 확인해 주세요.`);
    } finally {
      setLoading(false);
    }
  };
